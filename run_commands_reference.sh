...
# S5: center Y=325, X=320 | voxel=2.5000006400000005 | cc=90
...
python3 radial_boundary_estimation.py --stack Salicornia_5_stack.tif --slice 501 \
    --voxel-um 2.5000006400000005 --center-y 325 --center-x 320 --candidate-radii 90
...
#   S5: center=(325,320),  radii=(90,...)      , voxel=2.5000006400000005
